...
const StepperSidebar = ({
  ...
  return (
    <AppContainer className="hidden relative sm:flex w-full h-full">
      <div className="h-full px-5 pb-10 pt-10 bg-card border-l border-l-border flex flex-col justify-between">
  ...
  return (
    <div className="flex h-full">
      <AppContainer className="flex-1">
        <div className="flex flex-col gap-2 justify-center items-center sm:max-w-2xl w-full mx-auto mb-10 mt-10">

...
export const cardVisualSchema = z.object({
  ...
  title: z.string(),
  backPath: z.string(),
  width: z.number().default(1348),
  height: z.number().default(850),
...
export const cardVisualElementSchema = z.object({
  isOnFront: z.boolean().default(true),
  type: z.enum(["VARIABLE", "IMAGE", "TEXT"]).default("TEXT"),
...
export const cardSchema = z.object({
  ...
  cardFrontPath: z.string().optional(),
  cardBackPath: z.string().optional(),
